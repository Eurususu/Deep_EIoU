class Tracklet:
    def __init__(self, track_id=None, frames=None, scores=None, bboxes=None, feats=None, feat_scores=None):
        '''
        ...
        self.feat_scores = feat_scores if feat_scores is not None else []
    ...
    def append_feat(self, feat, feat_score):
        '''
    ...
    def extract(self, start, end):
        ...
        subtrack = Tracklet(self.track_id, self.times[start:end + 1], self.scores[start:end + 1], self.bboxes[start:end + 1], self.features[start:end + 1] if self.features else None,
                            self.feat_scores[start:end + 1] if self.feat_scores else None)
        return subtrack